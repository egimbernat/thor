...
custom_error! {
    ...
    EmptyMessage = "Message length was 0",
    ...
    CertificateRevoked = "This certificate has been revoked",
    ImpossibleError = "This shouldn't happen",
    BadDataArgs{msg: String} = "Unable to parse command args: {msg}",
    TimerError{source: tokio::time::error::Error} = "Unable to setup timer: {source}"
}
